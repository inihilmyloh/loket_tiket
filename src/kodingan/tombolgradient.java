...
public class tombolgradient extends JButton{
    ...
    private Color color1= Color.decode("#005AA7");
    private Color color2= Color.decode("#FFFDE4");
    ...
    private void createStyle(Graphics2D g2){
        ...
        int width = getWidth();
        int height = getHeight();
        //GradientPaint gra= new GradientPaint (0, 0, Color.WHITE, 0, height, new Color(225, 225, 225, 60));
        //g2.setPaint(gra);
